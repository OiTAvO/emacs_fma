...
(custom-set-variables
 ...
 '(ac-dcd-server-executable "~/DCD/bin/dcd-server")
 '(ac-delay 0.05)
 ...
 '(company-dcd-client-executable "~/DCD/bin/dcd-client")
 '(company-dcd-server-executable "~/DCD/bin/dcd-server")
 ...
 '(flycheck-d-dmd-executable "dmd")
 '(flycheck-dmd-dub-use-cache-p nil)
 '(flycheck-dmd-include-path (quote ("/usr/include/dmd/phobos")))
 ...
 '(python-shell-exec-path (quote ("/usr/bin/python3")))
